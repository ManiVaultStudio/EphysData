...
class EphysDataConan(ConanFile):
    ...
    name = "EphysData"
    description = """Data plugin that stores patch-seq experiment traces based on the .nwb format."""
    topics = ("manivault", "plugin", "data", "ephys")
    url = "https://github.com/ManiVaultStudio/EphysData"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/EphysData")
        cmake.verbose = True
        return cmake
